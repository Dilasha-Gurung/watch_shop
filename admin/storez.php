...
?>
    ...
    <div class="row mt-5">
        ...
        ?>
                <div class="col-md-3 mt-3">
                    ...
                    <button class="unstyled-button" onclick="myFunction()"><img src=../img/fav.png alt=fav style=width:20px;height:20px;float:right;></button>
                    <script>
                    function myFunction() {
    ...
    <div class="container">
      <p class="text-white"><span class="text-warning">Watch HERE -</span><?php echo date("Y"); ?> @ All Rights Reserve </p>
    </div>
    </footer> 
